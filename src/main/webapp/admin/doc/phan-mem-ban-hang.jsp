...
<header class="app-header">
  ...
  <ul class="app-nav">
    <!-- User Menu-->
    <li><a class="app-nav__item" href="../../login.jsp"><i class='bx bx-log-out bx-rotate-180'></i> </a></li>
  </ul>
</header>
<!-- Sidebar menu-->
        ...
        <div class="du--lieu-san-pham">
          <table class="table table-hover table-bordered">
            ...
            <tr>
              ...
              <td><img src="../img-sanpham/MDCPhongThuy/1.jpg" alt="" width="50px"></td>
            ...
            <tr>
              ...
              <td><img src="../img-sanpham/MDCPhongThuy/2.jpg" alt="" width="50px;"></td>
            ...
            <tr>
              ...
              <td><img src="../img-sanpham/MDCPhongThuy/3.jpg" alt="" width="50px;"></td>
            ...
            <tr>
              ...
              <td><img src="../img-sanpham/MDCPhongThuy/4.jpg" alt="" width="50px;"></td>
      ...
      <div class="tile">
        ...
        <div class="row">
          ...
          <div class="form-group  col-md-2">
            ...
            <button style="margin-top: 30px" class="btn btn-primary btn-them" data-toggle="modal" data-target="#exampleModalCenter"><i class="fas fa-user-plus"></i>
            </button>
          </div>
