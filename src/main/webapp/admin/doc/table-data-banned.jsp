...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    ...
    <li><a class="app-menu__item active" href="table-data-banned.jsp"><i class='app-menu__icon bx bx-run'></i><span
        ...
        <div class="tile-body">
          <div class="row element-button">
            <div class="col-sm-2">
              ...
              <a class="btn btn-add btn-sm" href="form-add-bi-cam.jsp" title="Thêm"><i class="fas fa-plus"></i>
                Tạo mới</a>
            </div>
            <div class="col-sm-2">
