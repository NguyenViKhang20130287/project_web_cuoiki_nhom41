...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="LoadListBannerControl"><i class="app-menu__icon fa-solid fa-sliders"></i>
            <span class="app-menu__label active">Quản lý banner</span></a></li>
                    ...
                    <form method="post" action="EditSliderControl">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div id="thumbbox">
                                    <img height="100" width="200" alt="Thumb image" id="thumbimage"
                                         src="<%=b.getImage()%>" name="image"/>
                        ...
                        <a class="btn btn-cancel" href="LoadListBannerControl">Hủy bỏ</a>
                    </form>
                    <BR>
