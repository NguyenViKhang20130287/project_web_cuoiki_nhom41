...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    ...
    <li><a class="app-menu__item active" href="table-data-oder.jsp"><i class='app-menu__icon bx bx-task'></i><span
        ...
        <div class="tile-body">
          ...
          <table class="table table-hover table-bordered" id="sampleTable">
            ...
            <tr>
              ...
              <td>5</td>
              <td>Phạm Thị Ngọc</td>
              <td>Vòng Tay Thạch Anh Ưu Linh Trắng 8mm Mix Hoa Mẫu Đơn</td>
              <td>2 </td>
              <td>19.770.000 đ</td>
            ...
            <tr>
              ...
              <td>6</td>
              <td>Ngô Thái An</td>
              <td>Vòng Tay Thạch Anh Ưu Linh Trắng 8mm Mix Bạc</td>
              <td>1 </td>
              <td>14.500.000 đ</td>
